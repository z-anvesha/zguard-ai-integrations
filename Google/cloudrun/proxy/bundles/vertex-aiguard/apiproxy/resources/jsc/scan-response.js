...
// Get configuration. The policy id comes from the KVM only — see scan-prompt.js.
...
context.setVariable('aiguard.response.present', responseText.length > 0 ? 'true' : 'false');
